...
class MASK_PCPA_3_2D_VISUAL(ActionPredict):
    """
    hierfusion MASK_PCPA
    Class init function
...
class MASK_PCPA_4_2D_ONLYVISUAL(ActionPredict):
    """
    hierfusion MASK_PCPA
    Class init function
    ...
    def get_model(self, data_params):
        ...
        net_model = Model(inputs=network_inputs,
                          outputs=model_output)
        net_model.summary()
        plot_model(net_model, to_file='MASK_PCPA_4_2D_ONLYVISUAL.png')
        return net_model
...
class MASK_PCPA_2D_VISUAL(ActionPredict):
    """
    Class init function
    ...
    def get_model(self, data_params):
        ...
        net_model = Model(inputs=network_inputs,
                          outputs=model_output)
        net_model.summary()
        plot_model(net_model, to_file='MASK_PCPA_2D_VISUAL.png')
        return net_model


class MASK_PCPA_3_2D_NONVISUAL(ActionPredict):
    """
    hierfusion MASK_PCPA
    Class init function
    ...
    def get_model(self, data_params):
        ...
        net_model = Model(inputs=network_inputs,
                          outputs=model_output)
        net_model.summary()
        plot_model(net_model, to_file='MASK_PCPA_3_2D_NONVISUAL.png')
        return net_model

class MASK_PCPA_2D_NONVISUAL(ActionPredict):
    """
    Class init function
    ...
    def get_model(self, data_params):
        ...
        net_model = Model(inputs=network_inputs,
                          outputs=model_output)
        net_model.summary()
        plot_model(net_model, to_file='MASK_PCPA_2D_NONVISUAL.png')
        return net_model
