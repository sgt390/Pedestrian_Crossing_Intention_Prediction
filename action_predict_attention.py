...
class LATER_TST_FULL(ActionPredict):
    ...
    def get_model(self, data_params):
        ...
        x = self._multi_self_attention(name='enc1_' + data_types[1], representation_size=attention_size, **transformer_params)(x)
        encoder_outputs.append(x)
        x = self.normlayer(name='norm2_'+data_types[2], axis=-1, momentum=0, epsilon=0.001)(network_inputs[2])
        ...
        encoder_outputs.append(x)
        x = self.normlayer(name='norm3_'+data_types[3], axis=-1, momentum=0.1, epsilon=0.001)(network_inputs[3])
        ...
        encoder_outputs.append(x)
        x = self.normlayer(name='norm4_'+data_types[4], axis=-1, momentum=0.1, epsilon=0.001)(network_inputs[4])
